...
const Footer = () => {
  return (
    <footer className="footer w-full relative z-20 overflow-hidden px-0 py-0 border-0">
      <div className="footer-content">
        <span className="footer-year animate-fadeInUp">
          <svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="inline-block text-[#00d8ff] animate-spin-slow">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6l4 2" />
          </svg>
          <span className="font-bold animate-gradientText">{new Date().getFullYear()} Aryan Pourtaheri</span>
          <span className="opacity-70">All rights reserved.</span>
        </span>
        <div className="footer-links">
          <a
            href="https://github.com/Aryan-Pourtaheri"
            target="_blank"
            rel="noopener noreferrer"
            className="footer-link animate-bounce-slow"
            aria-label="GitHub"
          >
            <svg width="28" height="28" fill="currentColor" viewBox="0 0 24 24" className="inline-block">
              <path d="M12 2C6.477 2 2 6.484 2 12.021c0 4.428 2.865 8.184 6.839 9.504.5.092.682-.217.682-.482 0-.237-.009-.868-.014-1.703-2.782.605-3.369-1.342-3.369-1.342-.454-1.156-1.11-1.464-1.11-1.464-.908-.62.069-.608.069-.608 1.004.07 1.532 1.032 1.532 1.032.892 1.53 2.341 1.088 2.91.832.091-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.987 1.029-2.687-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.025A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.295 2.748-1.025 2.748-1.025.546 1.378.202 2.397.1 2.65.64.7 1.028 1.594 1.028 2.687 0 3.847-2.338 4.695-4.566 4.944.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.749 0 .267.18.577.688.48C19.138 20.2 22 16.448 22 12.021 22 6.484 17.523 2 12 2z"/>
            </svg>
          </a>
          <a
            href="https://tr.linkedin.com/in/arian-pourtaheri-147567377"
            target="_blank"
            rel="noopener noreferrer"
            className="footer-link animate-bounce-slow"
            aria-label="LinkedIn"
